...
int main(int argc, char* argv[]){
	...
	if (mode == 0){
#if TASKSET == 1
		checkFileExist(MyString(pIdx) + "_1.txt");
		log.open(MyString(pIdx) + "_1.txt");
		log2.open(MyString(pIdx) + "_1_selection.txt");
#else
		checkFileExist(MyString(pIdx) + "_2.txt");
		log.open(MyString(pIdx) + "_2.txt");
		log2.open(MyString(pIdx) + "_2_selection.txt");
#endif
		logFile = &log;
		...
		*/
...
#if TASKSET == 1
		checkFileExist(MyString(pIdx) + "_training_1.txt");
		log.open(MyString(pIdx) + "_training_1.txt");
		log2.open(MyString(pIdx) + "_training_selection_1.txt");
#else
		checkFileExist(MyString(pIdx) + "_training_2.txt");
		log.open(MyString(pIdx) + "_training_2.txt");
		log2.open(MyString(pIdx) + "_training_selection_2.txt");
#endif
		logFile = &log;
		interactionLogFile = &log2;
		...
		if (DATASET == 0){
#if TASKSET == 1
			dropBoxFolder = "data\\task_configs_74_dualDensity_training_1\\";
#else
